          ...
          {loading ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="rounded-lg border border-border h-64 animate-pulse bg-secondary/50"
                />
              ))}
            </div>
                ...
                {selected.skills.length > 0 && (
                  <div className="flex flex-wrap gap-1.5">
                    {selected.skills.map((s) => (
                      <span
                        key={s}
                        className="text-xs px-2.5 py-1 rounded bg-secondary text-muted-foreground"
                      >
                        {s}
                      </span>
                    ))}
